...
- **الأسماء المستعارة الافتراضية**:
  - `free-auto`: طابور البرمجة الأساسي (أولوية Gemini 2.0 Flash / Llama 3.3 70B، وتراجع تلقائي إلى Ollama `qwen2.5-coder:7b`).
  - `free-fast`: طابور فائق السرعة وخفيف الوزن (Gemini Flash Lite / Llama 3.1 8B).
  - `free-code`: طابور مخصص لتوليد واختبار الأكواد.
...
### 3. احتياطي محلي دون اتصال ودون توقف (Ollama & LM Studio)

عند استنفاد الحصص السحابية أو انقطاع الاتصال، يقوم prismd بتوجيه الطلبات تلقائيًا إلى محركات الاستدلال المحلية:
